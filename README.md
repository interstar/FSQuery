...
Note that `quit` returns a boolean. By default it should be False. But return True if this node meets some criterion for abandoning the descent at this point. For example, if you've hit a maximum depth or 
because you have found a file you are searching for.
